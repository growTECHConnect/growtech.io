                    ...
                    <div className="acc_form_fields">
                        <div className="network_fields radio_group_wrap">
                            ...
                            <span className="gt_radio">
                                <input type="radio" id="active" name="active" checked={form.active ? 'on' : ''}
                                       onChange={() => this.setRadio('active', true)}/>
                                <label htmlFor="active">Active</label>
                            </span>
                            <span className="gt_radio">
                                <input type="radio" id="inactive" name="active" checked={form.active ? '' : 'on'}
                                       onChange={() => this.setRadio('active', false)}/>
